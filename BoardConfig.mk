...
BOARD_VENDOR_RAMDISK_KERNEL_MODULES_LOAD := $(strip $(shell cat $(DEVICE_PATH)/prebuilt/$(STOCK_KERNEL_ZUI_VER)/lib/modules/modules.load) )
...
#BOARD_AVB_SYSTEM_KEY_PATH := external/avb/test/data/testkey_rsa8192.pem
#BOARD_AVB_SYSTEM_ALGORITHM := SHA256_RSA8192
